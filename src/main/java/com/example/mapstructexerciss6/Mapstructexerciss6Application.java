package com.example.mapstructexerciss6;
...
public class Mapstructexerciss6Application implements CommandLineRunner {
    People people;
    People people2;
    ...
    public static void main(String[] args) {
        SpringApplication.run(Mapstructexerciss6Application.class, args);
    }
